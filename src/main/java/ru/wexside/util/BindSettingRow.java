...
public final class BindSettingRow
   extends SettingRow<BindSetting>
   ...
   public BindSettingRow(GuiBounds bounds2, BindSetting bindSetting, ContainerDisplay containerDisplay) {
      super(bounds2, bindSetting, new BindSettingComponent(bindSetting));
      this.compactSettingRow = new CompactSettingRow(
         new GuiBounds(0.0F, 0.0F, 0.0F, 0.0F), bindSetting::getDisplayName, bindSetting.getDescription(), containerDisplay
      );
   }
