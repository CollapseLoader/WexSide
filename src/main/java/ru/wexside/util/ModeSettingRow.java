...
public class ModeSettingRow
   extends SettingRow<ModeSetting>
   ...
   public ModeSettingRow(GuiBounds bounds2, ModeSetting modeSetting, ContainerDisplay containerDisplay) {
      super(bounds2, modeSetting, new ModeSettingComponent(modeSetting));
      this.compactSettingRow = new CompactSettingRow(
         new GuiBounds(0.0F, 0.0F, 0.0F, 0.0F), modeSetting::getDisplayName, modeSetting.getDescription(), containerDisplay
      );
   }
